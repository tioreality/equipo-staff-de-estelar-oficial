...
Que hace, en orden:
1. Carga y valida la configuracion desde .env.
2. Configura el sistema de logs.
3. Crea el bot y lo conecta a Discord.

Como detener el bot de forma segura:
- Presiona Ctrl+C en la terminal donde se esta ejecutando. discord.py
  cierra la conexion de forma ordenada al recibir esa senal.
"""
...
def main() -> int:
    ...
    logger.info("Iniciando Staff de Estelar Oficial (Jefe)...")
