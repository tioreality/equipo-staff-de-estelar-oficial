...
Igual que en cada bot/config.py: nada de secretos escritos aquí, todo
sale de variables de entorno. Si falta algo obligatorio, el panel no
arranca y explica exactamente qué falta.
"""
...
class PanelConfig:
    ...
    discord_bot_token: str  # token de la app "Staff de Estelar Oficial"; se usa para consultar roles
    guild_id: int
    admin_role_id: str
    session_secret: str
